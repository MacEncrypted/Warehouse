	...
	public function edit($id) {		
		...
		if($id == 0) {
			...
			if($this->input->post('sent')) {
				$this->notes_model->addNote($this->input->post('data'), $this->input->post('id_user'), 
						$this->input->post('title'), $this->input->post('text'));
			...
			// edit
			if($this->input->post('sent')) {
				$this->notes_model->updateNote($id, $this->input->post('data'), $this->input->post('id_user'), 
						$this->input->post('title'), $this->input->post('text'));
				redirect('notes/manage','refresh');
			} else {			
