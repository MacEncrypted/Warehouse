		...
		<div class="row"> 
			<div class="grid_5">
				<h1>Projekt Warehouse</h1>
                                <p>...to <b>idealne</b> narzędzie do monitorowania stanów magazynowych. Udostępnia wiele poziomów zarządzania produktami oraz przepływem danych w firmie.</p>
				<b>Ta wersja systemu została wykonana dla Bibtex-pol Sp. z o.o. przez Encrypted Software Maciej Lewandowski.</b>
			</div>
				...
				<div class="flexslider">
					<ul class="slides">
						<li>
							...
							<p class="flex-caption">Responsywny szablon - do odtwarzania na urządzeniach mobilnych.</p>
						</li>
						<li>
						...
						<li>
							...
							<p class="flex-caption">Prosty export CSV (do odtworzenia w Microsoft Excel lub Calc).</p>
						</li>
					</ul>
                </div><!-- FlexSlider -->
			</div><!-- end grid_7 -->
